...
def main():
    ...
    parser.add_argument('--test', choices=['hpa', 'auto-healing', 'all'], 
                       default='hpa', help='Tipo de teste')
    parser.add_argument('--duration', type=int, default=45, 
                       help='Duração do stress test em segundos')
    parser.add_argument('--url', default='http://localhost:5000',
                       help='URL do serviço PatoCash')
